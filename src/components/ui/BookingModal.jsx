    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto font-mono">
        ...
        <motion.div
          ...
          className="relative w-full max-w-xl bg-[#060608] border border-white/10 rounded-3xl overflow-hidden shadow-2xl z-10 glass-slate"
        >
          {/* Header */}
          <div className="bg-[#08080b] px-6 py-4 border-b border-white/10 flex items-center justify-between">
            <div className="flex items-center gap-2 text-xs text-white uppercase font-semibold">
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1">
                  <h3 className="text-xl font-extrabold text-white tracking-tight uppercase font-sans">BOOK A PRODUCTION</h3>
                ...
                <div className="space-y-4 text-xs">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-zinc-900/80 border border-white/10 focus:border-white px-4 py-3 rounded-xl text-white outline-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-zinc-900/80 border border-white/10 focus:border-white px-4 py-3 rounded-xl text-white outline-none resize-none font-sans"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-4 rounded-full bg-white hover:bg-zinc-200 text-black font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-xl active:scale-95"
                >
              ...
              <div className="py-8 text-center space-y-4 font-mono">
                ...
                <h3 className="text-2xl font-black text-white tracking-tight uppercase font-sans">BRIEF TRANSMITTED</h3>
